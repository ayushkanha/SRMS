...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  tblattendance1(StudentId,ClassId,SubjectId,attended,total) VALUES(:studentid,:class,:sid,:marks,:total)";
...
<html lang="en">
    <head>
        ...
        <title>SMS Admin| Add Attendance </title>
