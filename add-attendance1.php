...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i];
//   $sql="INSERT INTO  tblattendance(StudentId,ClassId,SubjectId,class_attended,total_class) VALUES(:studentid,:class,:sid,:marks,total_class)";

$sql="INSERT INTO  tblattendance(StudentId,ClassId,SubjectId,attended) VALUES(:studentid,:class,:sid,:marks)";
$query = $dbh->prepare($sql);
$query->bindParam(':studentid',$studentid,PDO::PARAM_STR);
$query->bindParam(':class',$class,PDO::PARAM_STR);
$query->bindParam(':sid',$sid,PDO::PARAM_STR);
$query->bindParam(':attended',$mar,PDO::PARAM_STR);
// $query->bindParam(':total_class',$total_class,PDO::PARAM_STR);
$query->execute();
...
<div class="alert alert-success left-icon-alert" role="alert">
 <strong>Well done!</strong><?php echo htmlentities($msg); ?>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                        ...
                                        <?php } ?>
                                                <in class="form-horizontal" method="post">
...
<div class="form-group">
                                                    ...
                                                    <!-- <label for="date" class="col-sm-2 control-label">Total classes</label>
                                                    <input name="total_class" type="text" class="col-sm-10"  required="required" placeholder="Enter total no. of classes"> -->
                                                    
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="submit" id="submit" class="btn btn-primary">Add Attendance</button>
                                                        </div>
                                                    </div>
                                                </form>
